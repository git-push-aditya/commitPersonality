...
export function GithubIcon({ dim, style }: genIconStyle) {
  return <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width={dim} height={dim} viewBox="0 0 50 50" className={style}>
...
export function TwitterIcon({ dim, style }: genIconStyle) {
  return <a href="https://x.com/AdityaDtwt" target="_blank" rel="noopener noreferrer"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width={dim} height={dim} className={` cursor-pointer ${style}`} viewBox="0 0 30 30">
