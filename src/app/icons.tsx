...
export function TopBarSVG({ dim, style,onClickHandler }: genIconStyle) {
  return <svg width={dim} onClick={onClickHandler}
    height={dim}
    className={` cursor-pointer ${style}`} fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 92.833 92.833" xmlSpace="preserve" stroke="#000000" strokeWidth="1.949493"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round" stroke="#CCCCCC" strokeWidth="2.599324"></g><g id="SVGRepo_iconCarrier"> <g> <g> <path d="M89.834,1.75H3c-1.654,0-3,1.346-3,3v13.334c0,1.654,1.346,3,3,3h86.833c1.653,0,3-1.346,3-3V4.75 C92.834,3.096,91.488,1.75,89.834,1.75z"></path> <path d="M89.834,36.75H3c-1.654,0-3,1.346-3,3v13.334c0,1.654,1.346,3,3,3h86.833c1.653,0,3-1.346,3-3V39.75 C92.834,38.096,91.488,36.75,89.834,36.75z"></path> <path d="M89.834,71.75H3c-1.654,0-3,1.346-3,3v13.334c0,1.654,1.346,3,3,3h86.833c1.653,0,3-1.346,3-3V74.75 C92.834,73.095,91.488,71.75,89.834,71.75z"></path> </g> </g> </g></svg>
}

export function CrossTopBar ({ dim, style,onClickHandler }: genIconStyle) {
  return <svg width={dim} onClick={onClickHandler}
    height={dim}
...
export function ChatbotEnter ({ dim, style, onClickHandler }: genIconStyle) {
...
export function BlockIcon ({ style }: genIconStyle){
